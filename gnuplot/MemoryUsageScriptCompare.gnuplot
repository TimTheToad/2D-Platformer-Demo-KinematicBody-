...
plot gsSaveData0 using 4 title '1', gsSaveData1 using 4 title '2', gsSaveData2 using 4 title '3'

set title "Save State RAM Utilization Ga"
plot gaSaveData0 using 4 title '1', gaSaveData1 using 4 title '2', gaSaveData2 using 4 title '3'

set title "Load State RAM Utilization Gs"
plot gsLoadData0 using 4 title '1', gsLoadData1 using 4 title '2', gsLoadData2 using 4 title '3'

set title "Load State RAM Utilization Ga"
plot gaLoadData0 using 4 title '1', gaLoadData1 using 4 title '2', gaLoadData2 using 4 title '3'
